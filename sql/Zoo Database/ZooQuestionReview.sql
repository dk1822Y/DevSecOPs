...
List the pairs of team IDs which have the exact same associates.
Include the associate ID as well.
...
Select all products and their purchase and/or finish date (if
they have one). Order your results by finish date within purchase
date (purchase date will come first).;
